...
extern "C++" __declspec(dllexport) void BubbleSort(int* sortingArray, int sizeArray)
{
	int temp = 0;
...
extern "C++" __declspec(dllexport) void QuickSort(int* sortingArray, int sizeArray, int left, int right)
{
